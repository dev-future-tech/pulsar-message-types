...
public class TestMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4602894407520358290L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TestMessage\",\"namespace\":\"com.example.model\",\"fields\":[{\"name\":\"messageId\",\"type\":\"string\"},{\"name\":\"message\",\"type\":\"string\"}]}");
   ...
   */
  public TestMessage(java.lang.CharSequence messageId, java.lang.CharSequence message) {
   ...
   */
  public static com.example.model.TestMessage.Builder newBuilder() {
    return new com.example.model.TestMessage.Builder();
  }
   ...
   * @return A new TestMessage RecordBuilder
   */
  public static com.example.model.TestMessage.Builder newBuilder(com.example.model.TestMessage.Builder other) {
    if (other == null) {
      return new com.example.model.TestMessage.Builder();
    } else {
      return new com.example.model.TestMessage.Builder(other);
    }
  }
   ...
   * @return A new TestMessage RecordBuilder
   */
  public static com.example.model.TestMessage.Builder newBuilder(com.example.model.TestMessage other) {
    if (other == null) {
      return new com.example.model.TestMessage.Builder();
    } else {
      return new com.example.model.TestMessage.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TestMessage>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.model.TestMessage.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.model.TestMessage other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.messageId)) {
        this.messageId = data().deepCopy(fields()[0].schema(), other.messageId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.model.TestMessage.Builder setMessageId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.model.TestMessage.Builder clearMessageId() {
      messageId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.model.TestMessage.Builder setMessage(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.model.TestMessage.Builder clearMessage() {
      message = null;
